...
urlpatterns = [
    ...
    url(r'^user/home/venue/(?P<venue_id>\d+)/reports/$', summary.summary_report, name='summary_report'),

    url(r'^user/home/venue/(?P<venue_id>\d+)/reports/employees/$', employee.employee_report, name='employee_report'),
