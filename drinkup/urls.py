...
from main.views import (home, user_session, index, registration, venue, menu, item, employee, order, bartinterface, unclaimed)
...
urlpatterns = [
    ...
    url(r'^user/home/bartui/(?P<employee_id>\d+)/(?P<venue_id>\d+)/$', bartinterface.display, name='bartui'),
